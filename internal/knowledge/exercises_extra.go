...
`,
		Description: "Печатает все возрастающие тройки цифр (i<j<k из 0-9) через ', ' — без trailing ', ', с финальным '\\n'. Идентичен по выводу стандартному PrintComb.",
		Concepts:    []string{"printcomba", "печать", "вывод", "print", "комбинации", "combinations"},
		Samples: `piscine.PrintComba() →
012, 013, 014, 015, 016, 017, 018, 019, 023, 024, 025, 026, 027, 028, 029, 034, 035, 036, 037, 038, 039, 045, 046, 047, 048, 049, 056, 057, 058, 059, 067, 068, 069, 078, 079, 089, 123, 124, 125, 126, 127, 128, 129, 134, 135, 136, 137, 138, 139, 145, 146, 147, 148, 149, 156, 157, 158, 159, 167, 168, 169, 178, 179, 189, 234, 235, 236, 237, 238, 239, 245, 246, 247, 248, 249, 256, 257, 258, 259, 267, 268, 269, 278, 279, 289, 345, 346, 347, 348, 349, 356, 357, 358, 359, 367, 368, 369, 378, 379, 389, 456, 457, 458, 459, 467, 468, 469, 478, 479, 489, 567, 568, 569, 578, 579, 589, 678, 679, 689, 789

Формат: первая тройка "012", последняя "789", без trailing ", ", финальный '\n'. Всего 120 троек, 599 байт включая '\n'.`,
	},
	{
		Name:        "printcombb",
...
// quest 2.
`,
		Description: "Печатает все возрастающие тройки цифр (i<j<k из 0-9) через ', ' — без trailing ', ', с финальным '\\n'. Стандартный PrintComb.",
		Concepts:    []string{"printcombb", "printcomb", "печать", "вывод", "print", "комбинации", "combinations"},
		Samples: `piscine.PrintComb() →
012, 013, 014, 015, 016, 017, 018, 019, 023, 024, 025, 026, 027, 028, 029, 034, 035, 036, 037, 038, 039, 045, 046, 047, 048, 049, 056, 057, 058, 059, 067, 068, 069, 078, 079, 089, 123, 124, 125, 126, 127, 128, 129, 134, 135, 136, 137, 138, 139, 145, 146, 147, 148, 149, 156, 157, 158, 159, 167, 168, 169, 178, 179, 189, 234, 235, 236, 237, 238, 239, 245, 246, 247, 248, 249, 256, 257, 258, 259, 267, 268, 269, 278, 279, 289, 345, 346, 347, 348, 349, 356, 357, 358, 359, 367, 368, 369, 378, 379, 389, 456, 457, 458, 459, 467, 468, 469, 478, 479, 489, 567, 568, 569, 578, 579, 589, 678, 679, 689, 789
...
*/`,
		Description: "Программа печатает таблицу умножения для числа N (CLI-аргумент): 9 строк формата 'i x N = i*N'. Если аргументов не ровно 1, или аргумент не парсится как int — выводит одну пустую строку и выходит.",
		Concepts:    []string{"tabmult", "таблица", "умножение", "multiplication"},
		Samples: `$ ./tabmult 2
1 x 2 = 2
2 x 2 = 4
3 x 2 = 6
...
`,
		...
		Concepts:    []string{"quada", "прямоугольник", "rectangle", "квад", "quad", "рамк"},
...
`,
		...
		Concepts:    []string{"quadb", "прямоугольник", "rectangle", "квад", "quad", "рамк"},
...
`,
		...
		Concepts:    []string{"quadc", "прямоугольник", "rectangle", "квад", "quad", "рамк"},
...
`,
		...
		Concepts:    []string{"quadd", "прямоугольник", "rectangle", "квад", "quad", "рамк"},
...
`,
		...
		Concepts:    []string{"quade", "прямоугольник", "rectangle", "квад", "quad", "рамк"},
