...
// AI chat mode. Intentionally minimal: just clear-the-dialog and exit-to-
// main-menu. The student's only job is to type the exercise name; any
// extra buttons would crowd that affordance.
